...
<?php } else { ?>
						<li><a href="https://slack.com/openid/connect/authorize?response_type=code&amp;scope=openid,profile&amp;team=<?=SLACK_TEAM_ID?>&amp;client_id=<?=SLACK_CLIENT_ID?>&amp;redirect_uri=<?=BASE_URL.'auth'?>"><i class="fa fa-fw fa-user-times fa-lg"></i>&nbsp; Log In</a></li>
<?php } ?>
					</ul>
